      ...
      'data|3': [
        {
          ...
          'sell|+1': ['已抢15810件', '已抢222件', '已抢86件'],
          'des|+1': [
            '10片草木之心冰泉玻尿酸面膜',
            '加绒连帽懒惰风韩版外套',
            '北极绒仙女暖暖裤套装加绒'
          ],
          'price|+1': ['￥12.9', '￥37.9', '￥22.8'],
          'oldprice|+1': ['49', '99.09', '88.05']
        }
      ],
      status: 200,
      msg: '请求成功'
        ...
        'data|10': [
          {
            ...
            'title|+1': ['网红小白鞋女《单绒可选》', '半高领德绒打底衫'],
            'progress|+1': ['8', '28'],
            'price|+1': ['19.9', '49'],
            'oldprice|+1': ['599', '149'],
            'tips|+1': ['近30天最低价', '近50天最低价']
          }
        ]
      })
        ...
        'data|10': [
          {
            ...
            'title|+1': ['情侣装毛衣针织衫男女同款', '儿童棉拖鞋秋冬季女童棉鞋'],
            'progress|+1': ['39', '28'],
            'price|+1': ['29.9', '49'],
            'oldprice|+1': ['599', '149'],
            'tips|+1': ['近30天最低价', '近50天最低价']
        ...
        'data|10': [
          {
            ...
            'progress|+1': ['8', '28', '45'],
            'price|+1': ['19.9', '49', '32'],
            'oldprice|+1': ['599', '149', '288'],
            'tips|+1': ['近30天最低价', '近50天最低价', '近60天最低价']
          }
        ]
      })
    } else {
        ...
        'data|10': [
          {
            ...
            'progress|+1': ['56', '18', '25'],
            'price|+1': ['29.9', '39', '38'],
            'oldprice|+1': ['399', '149', '288'],
            'tips|+1': ['近20天最低价', '近50天最低价', '近60天最低价']
          }
        ]
      })
    }
