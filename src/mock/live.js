      ...
      'data|10': [
        {
          ...
          'goods|+1': [
            [
              {
                image:
                  'https://s11.mogucdn.com/mlcdn/c45406/201105_5d30ll85hf39828lh2a62ak38e09d_640x960.jpg_100x100.jpg',
                price: '￥@integer(1, 100)'
              },
              {
                image:
                  'https://s5.mogucdn.com/mlcdn/c45406/201015_647bbhc78i19id5g3j522a86c3lbf_640x960.jpg_100x100.jpg',
                price: '￥@integer(1, 100)'
              }
            ]
          ],
  ...
  getLivesById: (config) => {
    ...
    if (params.id === 0) {
      list = Mock.mock({
        data: {
          avatar:
            'https://s11.mogucdn.com/mlcdn/c45406/200316_1d19kb00gh7125k1h9gifhbfbceke_400x400.jpg_100x9999.v1c7E.70.webp',
          name: '可乐姐',
          goods: [
            {
              image:
