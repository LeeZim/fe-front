 ...
 * 限时快抢
 */
export const getFastBuyGoods = (params) =>
  request({
 ...
 * 即将售罄与我的快抢
 */
export const getPromotionGoods = (params) =>
  request({
